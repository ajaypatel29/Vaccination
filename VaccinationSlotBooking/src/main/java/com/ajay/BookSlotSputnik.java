...
/**
 * Servlet implementation class BookSlotSputnik
 */
@WebServlet("/BookSlotSputnik")
public class BookSlotSputnik extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public BookSlotSputnik() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			st1.setString(2, "Sputnik");
			st.executeUpdate();
			st1.executeUpdate();
			cst2.execute(("update vaccines set Sputnik = Sputnik - 1  where date = curdate()"));
